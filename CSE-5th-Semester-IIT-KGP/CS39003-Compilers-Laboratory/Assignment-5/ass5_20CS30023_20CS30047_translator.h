...
class SymbolType {
    public:
        enum typeEnum {void_, char_, int_, float_, pointer_, func_, array_, block_ } type;  // type of the symbol, scoped enum for safe comparisons
        int width;   // width of the symbol
        SymbolType *arrayType;  // type of the array elements
        SymbolType(typeEnum, SymbolType * = NULL, int = 1);  // constructor
        int getSize();  // getter function for the size(width) of the symbol
        string toString(); // converter to string representation of the type
};
// Symbol table class
class SymbolTable {
    public:
...
class Symbol {
    public:
        ...
        Symbol(string, SymbolType::typeEnum = SymbolType::int_, string = "");  // constructor
...
class Quad {
    public:
        string op, arg1, arg2, result;  // parameters of the quad class
...
extern Symbol *currentSymbol;  // current symbol pointer
extern SymbolType::typeEnum currentType;  // stores the current type
